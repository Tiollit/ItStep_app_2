...
int main()
{
    ...
    {        
        ...
        p = p - 1;
        c = 1;
        if (a < 10 && a != 6 && a != 3) d = d + a;    // додаємо останню справа цифру, якщо вона не 3 або 6
        else if (a < 10 && a == 3) d = d / 10;        // скорочуємо останню цифру якщо вона 3
        else if (a < 10 && a == 6) d = d / 10;        // скорочуємо останню цифру якщо вона 6
    }
